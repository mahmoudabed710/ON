  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/health-hero-bg.png')" }}
        aria-hidden="true"
      />
      ...
      >
        ...
        <p
          className="font-tajawal font-medium text-text-muted max-w-[500px]"
          style={{ fontSize: 'clamp(16px, 2vw, 24px)' }}
        >
          حلول تسويقية مبتكرة لقطاع الرعاية الصحية.
        </p>
      </div>
    </section>
  );
