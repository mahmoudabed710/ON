...
export default function FinanceHero() {
  ...
  return (
    <section
      ...
      aria-label="الخدمات المالية والمهنية"
      dir="rtl"
    >
      {/* Background — business professional photo */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/assets/finance-hero-bg.jpg')" }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, rgba(11,14,15,0.55) 0%, rgba(11,14,15,0.45) 55%, rgba(11,14,15,0.80) 100%)',
        }}
        aria-hidden="true"
      />
      ...
      >
        <h1
          ...
          style={{ fontSize: 'clamp(30px, 5.5vw, 88px)', lineHeight: '1.05' }}
        >
        ...
        >
          حلول رقمية مبتكرة للمؤسسات المالية والاستشارية
        </p>
      </div>
    </section>
  );
